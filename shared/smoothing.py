...
Shared by the treadmill filter steps (`treadmill/scripts/03_filter_savitzky_golay.py`,
`04_filter_butterworth.py`) and their bike counterparts in `bike/scripts/`, so
