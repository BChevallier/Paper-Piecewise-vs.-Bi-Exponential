...
`bike/data/prepared/<trial>_time_trial_sg_filtered.csv`.

Usage:
    python bike/scripts/03_filter_savitzky_golay.py        # both trials
    python bike/scripts/03_filter_savitzky_golay.py tt1    # one trial
"""
