...
Usage:
    python bike/scripts/01_xml_to_csv.py            # both trials
    python bike/scripts/01_xml_to_csv.py tt1        # one trial
"""
...
INPUT_FOLDER = REPO_ROOT / "bike" / "data" / "raw" / "cpet_exports"
OUTPUT_ROOT = REPO_ROOT / "bike" / "data" / "converted"
