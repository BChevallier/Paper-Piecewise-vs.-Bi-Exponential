...
`figures/tt4_measured_vs_estimated.png`. By default it shows only the
...
(`preparedGeneralData.csv`'s `o2_intercept_y + o2_slope_y * speedTT4`) — a
...
Run from anywhere, e.g. `python code/data_visualization/07_plot_participants.py`
from the repo root.
"""
...
SG_FILTERED_PATH = PREPARED_DIR / "sg_filtered_4mintt.csv"
BW_FILTERED_PATH = PREPARED_DIR / "bw_filtered_4mintt.csv"
UNFILTERED_PATH = PREPARED_DIR / "preparedTimeTrial.csv"
GENERAL_DATA_PATH = PREPARED_DIR / "preparedGeneralData.csv"
BREAKPOINTS_PATH = RESULTS_DIR / "tt4_breakpoints_piecewise.csv"

OUTPUT_PATH = FIGURES_DIR / "tt4_measured_vs_estimated.png"
