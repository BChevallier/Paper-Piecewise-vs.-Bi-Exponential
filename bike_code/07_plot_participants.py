...
Writes `figures/bike_<trial>_participants.png`.

Usage:
    python bike_code/07_plot_participants.py        # both trials
    python bike_code/07_plot_participants.py tt1    # one trial
"""
...
def plot_trial(trial):
    ...
    breakpoints = (
        pd.read_csv(RESULTS_DIR / f"{trial}_breakpoints_piecewise.csv", index_col=0)
    ...
    output_path = FIGURES_DIR / f"bike_{trial}_participants.png"
