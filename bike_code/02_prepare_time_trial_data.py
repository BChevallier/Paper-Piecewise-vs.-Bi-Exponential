...
`bike_data/prepared_data/<trial>_prepared_time_trial.csv`.
...
Usage:
    python bike_code/02_prepare_time_trial_data.py        # both trials
    python bike_code/02_prepare_time_trial_data.py tt1    # one trial
"""
