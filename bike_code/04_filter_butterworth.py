...
`bike_data/prepared_data/<trial>_bw_filtered.csv`.

Usage:
    python bike_code/04_filter_butterworth.py        # both trials
    python bike_code/04_filter_butterworth.py tt1    # one trial
"""
